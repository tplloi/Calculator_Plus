...
import com.roy.calculator.logic.ConversionUnit
import com.roy.calculator.viewmodels.UnitState
...
fun UnitValue(
    ...
    TextButton(onClick = { menuOpened = true }) {
        ...
        DropdownMenu(expanded = menuOpened, onDismissRequest = { menuOpened = false }) {
            options.forEach {
                DropdownMenuItem(contentPadding = PaddingValues(start = 20.dp, end = 30.dp),
    ...
    OutlinedTextField(unitState.value,
        onValueChange = {},
        readOnly = true,
